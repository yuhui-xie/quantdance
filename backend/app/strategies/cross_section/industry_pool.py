...
_SUB_SPECIFIC: list[tuple[str, tuple[str, ...]]] = [
    ...
    # 会把 A500/中证500 等非金融 ETF 误归入证券桶。只认"证券公司/券商"等目标词。
    ("证券", ("证券公司", "券商")),
    ("保险", ("保险", "非银金融")),
...
_SUB_FALLBACK: list[tuple[str, tuple[str, ...]]] = [
    ("科技", ("科技", "创新", "数字经济", "软件50")),  # 科技龙头ETF/科技ETF 等纯科技大类
    ("医药", ("医药", "医疗", "医服", "制药", "卫生", "健康")),
    ("消费", ("消费", "零售", "商贸", "免税", "旅游", "可选消费", "日常消费", "饮食", "品牌")),
    ("新能源", ("新能源", "绿色电力", "清洁能源", "低碳", "碳中和")),
    ("能源", ("能源", "石油", "油气", "原油", "石化", "天然气")),
]

SUB_RULES: list[tuple[str, tuple[str, ...]]] = _SUB_SPECIFIC + _SUB_FALLBACK
...
_EXCLUDE_TOKENS: tuple[str, ...] = (
    ...
    "欧股", "越南", "印度", "韩国", "中韩", "新加坡", "泰国", "全球", "海外", "跨境",
